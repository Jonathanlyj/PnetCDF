...
int main(int argc, char *argv[]) {
    ...
    double create_time = MPI_Wtime() - start_time1;
#ifdef MEM_TRACKING
    ...
    double create_file_time = start_time1 - start_time;
    ...
    //     }
    // }
    double times[5] = {end_to_end_time, create_file_time, create_time, enddef_time, close_time};
    char *names[5] = {"End-to-End", "Create File", "Metadata Consistency Check (intra-metadata block)", "End-define", "Close"};
    double max_times[5];
